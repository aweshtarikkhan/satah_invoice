...
export const EmailChangeEmail = ({ oldEmail, newEmail, confirmationUrl, siteUrl = 'https://satahinvoice.com' }: Props) => (
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            You requested to change your {BRAND} account email from <strong>{oldEmail}</strong> to <strong>{newEmail}</strong>.
          </Text>
          ...
          <Hr style={hr} />
          <Text style={footer}><strong>Didn't request this?</strong> Please secure your account immediately by resetting your password.</Text>
        </Section>
